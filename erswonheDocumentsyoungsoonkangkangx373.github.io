...
user.email=leex5089@umn.edu
user.name=leex5089
user.name=leex5089cd
user.name=leex5089cd
user.name=leex5089cd
user.name=leex5089cd
user.name=leex5089cd
...
remote.origin.url=https://github.com/kangx373/kangx373.github.io.git
remote.origin.fetch=+refs/heads/*:refs/remotes/origin/*
branch.master.remote=origin
branch.master.merge=refs/heads/master
credential.helper=store
user.name=Youngsoon Kang
user.email=kangx373@umn.edu
